...
import (
	...
	"github.com/sold-out-dev/sold-universal-sdk-go/akamai/internal"
	"github.com/sold-out-dev/sold-universal-sdk-go/internal/orderedobject"
)
...
var (
	...
	ErrSecCptParsing       = errors.New("universal-sdk: error parsing sec-cpt")
	ErrSecCptInvalidCookie = errors.New("universal-sdk: malformed sec_cpt cookie")
)
