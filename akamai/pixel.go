...
var (
	...
	ErrPixelHtmlVarNotFound   = errors.New("universal-sdk: pixel HTML var not found")
	ErrPixelScriptUrlNotFound = errors.New("universal-sdk: script URL not found")
	ErrPixelScriptVarNotFound = errors.New("universal-sdk: script var not found")
)
